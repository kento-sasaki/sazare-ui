...
> ⚠️ **現状について**: このファイルは現時点では「ドキュメント体系の方針記録 + 着手予定一覧」として機能している。全 28 ドキュメントが揃った後、本格的な「全体目次・ナビゲーション」として書き換える予定。
...
| 2   | `components/_template.md`          | Spec テンプレートを固める          |
| 3   | `vision.md`                        | 方向性を確定                       |
| 4   | `principles/design-principles.md`  | デザイン判断基準                   |
| 5   | `principles/accessibility.md`      | アクセシビリティ基準               |
| 6   | `principles/api-design.md`         | API 設計指針                       |
| 7   | `principles/naming-conventions.md` | 命名規則                           |
| 8   | `tokens/color.md`                  | カラートークン                     |
| 9   | `tokens/typography.md`             | タイポグラフィトークン             |
| 10  | `tokens/spacing.md`                | スペーシングトークン               |
| 11  | `tokens/radius.md`                 | ボーダーラジアストークン           |
| 12  | `tokens/shadow.md`                 | シャドウトークン                   |
| 13  | `tokens/breakpoint.md`             | ブレークポイントトークン           |
| 14  | `tokens/motion.md`                 | モーショントークン                 |
