...
// BadgeとほぼProps・見た目形状を共有するが、Issueが分かれているため独立したrecipe/コンポーネントとして持つ
export const statusLabelRecipe = defineRecipe({
  className: 'statusLabel',
  description: 'The styles for the StatusLabel component',
  base: {
    display: 'inline-flex',
    alignItems: 'center',
    borderRadius: 'full',
